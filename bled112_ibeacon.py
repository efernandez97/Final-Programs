...
"""
    ...
    # set TX power level
#    ble_cmd_hardware_set_txpower(ser, 15)
...
def ble_cmd_hardware_set_txpower(p, power):
    p.write(struct.pack('<4BB', 0, 1, 7, 12, power))
#def ble_cmd_hardware_set_txpower(power)
#    harware_set_txpower(15)
